function [roi,sur,orig,C,Cfilt,Cbg,M,nroi,maxnroi,copyInd,Ind,mCn,corrthr]=ROIdetect(Cn,maxdata,data,chunks,rem,bgt,maxradius,maxnroi,filters,file_name,root)
